...
public class WebMagicDemo1 implements PageProcessor {
    ...
    public void process(Page page) {
        if(!page.getUrl().regex("http://www.cnblogs.com/[a-z 0-9 -]+/p/[0-9]{7}.html").match()){
            //加入满足条件的链接
//            page.addTargetRequests(page.getHtml().xpath("//*[@id=\"post_list\"]").all());
...
//            );
        ...
        //*[@id="post_list"]/div[1]
        //*[@id="post_list"]/div[1]/div[2]
        //*[@id="post_list"]/div[1]/div[2]/h3
        //*[@id="post_list"]/div[1]/div[2]/h3/a
        //*[@id="Header1_HeaderTitle"]
        //*[@id="post_list"]/div[1]/div[2]/h3/a
        //*[@id="post_list"]/div[2]/div[2]/h3/a
    }
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new WebMagicDemo1()).addUrl("https://www.cnblogs.com/").thread(5).run();
